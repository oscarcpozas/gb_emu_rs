...
impl Channel4 {
    ...
    pub fn read_reg(&self, addr: u16) -> u8 {
        match addr {
            0xFF20 => 0xFF,
            0xFF21 => (self.initial_volume << 4) | ((self.env_add as u8) << 3) | self.env_period,
            0xFF22 => (self.clock_shift << 4) | ((self.width_mode as u8) << 3) | self.divisor_code,
    ...
    fn trigger(&mut self) {
        ...
        self.lfsr = 0x7FFF;
        self.freq_timer = (DIVISOR_TABLE[self.divisor_code as usize] << self.clock_shift) as i32;
    ...
    pub fn tick(&mut self, t_cycles: u32) -> u8 {
        ...
        while self.freq_timer <= 0 {
            let period = (DIVISOR_TABLE[self.divisor_code as usize] << self.clock_shift) as i32;
